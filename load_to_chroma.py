...
# # Load JSON data(1000papers for debug)
# try:
#     with open(JSON_PATH, "r", encoding='utf-8') as f:
#         data = json.load(f)
#     logging.info(f"Successfully loaded data from {JSON_PATH}. Total documents: {len(data)}")

#     # Limit to first 1000 papers
#     data = data[:1000]
#     logging.info(f"⚠️ Loading only FIRST {len(data)} papers into ChromaDB (debug mode)")
